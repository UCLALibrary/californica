...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_search_field('all_fields', label: 'All Fields') do |field|
      search_fields = 'title_tesim subject_tesim named_subject_tesim location_tesim description_tesim caption_tesim local_identifier_sim ark_ssi normalized_date_tesim architect_tesim photographer_tesim'
