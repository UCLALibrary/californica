  ...
  let(:metadata) do
    {
      ...
      "Genre" => "Sci-Fi Fantasy Fiction", # genre
      ...
      "Local ID" => "UCLA-1234e", # local_identifier
      ...
      "Subject name" => "The Evil Corporation", # named_subject
      ...
      "Repository" => "EchoParqueRepo", # repository
