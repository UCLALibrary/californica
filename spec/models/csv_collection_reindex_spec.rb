...
RSpec.describe CsvCollectionReindex, type: :model do
  subject(:collection_reindex) { FactoryBot.build(:csv_collection_reindex) }

  describe '#ark' do
    it 'is stored' do
      expect(collection_reindex.ark).to be_instance_of(String)
    end
  end
  ...
  describe '#csv_import_id' do
    ...
    it 'is stored' do
      expect(collection_reindex.csv_import_id).to be_instance_of(String)
    end
  ...
  describe '#status' do
    it 'is stored' do
      expect(collection_reindex.status).to be_instance_of(String)
    end
  end

  describe '#error_messages' do
    it 'is stored' do
      expect(collection_reindex.error_messages).to be_instance_of(Array)
    end
  end

  describe '#start_time' do
    it 'is stored' do
      expect(collection_reindex.start_time).to be_instance_of(ActiveSupport::TimeWithZone)
    end
  end

  describe '#end_time' do
    it 'is stored' do
      expect(collection_reindex.end_time).to be_instance_of(ActiveSupport::TimeWithZone)
    end
  end

  describe '#elapsed_time' do
    it 'is stored' do
      expect(collection_reindex.elapsed_time).to be_instance_of(Float)
    end
  end

  describe '#no_of_children' do
    it 'is stored' do
      expect(collection_reindex.no_of_children).to be_instance_of(Integer)
    end
  end
end
