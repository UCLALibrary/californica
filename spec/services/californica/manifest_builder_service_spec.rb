  ...
  describe '#iiif_base_url' do
    ...
    context 'when access_copy starts with \'http://\'' do
      ...
      it 'uses the link as is' do
        expect(service.iiif_base_url).to eq 'http://iiif.library.ucla.edu/iiif/2/finaltest1'
      end
    end
    ...
    context 'when access_copy starts with \'https://\'' do
      ...
      it 'uses the link as is' do
        expect(service.iiif_base_url).to eq 'https://iiif.library.ucla.edu/iiif/2/finaltest1'
      end
    end
    ...
    context 'when access_copy starts with \'Masters/\'' do
      ...
      it 'creates a link to the old cantaloupe' do
        ...
        expect(service.iiif_base_url).to eq 'https://old.cantaloupe.url/iiif/2/Masters%2Fdlmasters%2Ffinaltest1'
      end
    end
    ...
    context 'when access_copy starts with \'ark:/\'' do
      ...
      it 'creates a link to the new cantaloupe' do
        ...
        expect(service.iiif_base_url).to eq 'https://new.cantaloupe.url/iiif/2/ark%3A%2F123%2F456'
      end
    end
    ...
    context 'when access_copy is nil' do
      ...
      it 'returns nil' do
        expect(service.iiif_base_url).to eq nil
      end
    end
  end
