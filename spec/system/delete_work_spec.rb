...
RSpec.describe 'Delete a Work', :clean, type: :system, js: true do
  let(:work) { FactoryBot.create(:work, ark: 'ark:/abc/1234', iiif_manifest_url: 'https://iiif.library.ucla.edu/collections/ark%3A%2F21198%2Fz11c574k') }
  let(:recreated_work) { FactoryBot.create(:work, ark: 'ark:/abc/1234', iiif_manifest_url: 'https://iiif.library.ucla.edu/collections/ark%3A%2F21198%2Fz11c574k') }
