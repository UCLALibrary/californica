...
RSpec.describe 'Import and Display a Work', :clean, type: :system, inline_jobs: true, js: true do
  ...
  it "imports records from a csv" do
    ...
    expect(page).to have_content "Local Rights Statement-1" # local_rights_statement # This invokes License renderer from hyrax gem
  ...
  it "imports records from a csv with license" do
    ...
    expect(page).to have_content "local_rights_statement" # local_rights_statement # This invokes License renderer from hyrax gem
  end
end
