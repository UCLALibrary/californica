...
RSpec.describe 'Import and Display a Work', :clean, type: :system, inline_jobs: true, js: true do
  ...
  it "imports records from a csv" do
    ...
    expect(page).to have_content "UCLA Charles E. Young Research Library Department of Special Collections, A1713 Young Research Library, Box 951575, Los Angeles, CA 90095-1575. E-mail: spec-coll@library.ucla.edu. Phone: (310)825-4988" # services_contact
    ...
    expect(page).to have_content 'Archival Collection Title-2' # archival_collection_title
